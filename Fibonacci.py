...
class mainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        mainWindow_icon.addPixmap(QPixmap("./Icones/icon.png"))
        self.setWindowIcon(mainWindow_icon)
        ab = QLabel(self)
        ab.setStyleSheet("QLabel { background-color : transparent; color : black; font-size : 35px;}")
        ab.resize(360,50)
        ab.setText("Sequência de Fibonacci")
        ab.move(195,10)

        n1_text = QLabel(self)
        n1_text.setStyleSheet("QLabel { background-color : transparent; color : black; font-size : 20px;}")
        ...
        n1_line.setStyleSheet("background-color: #f7bb6e;")

        n2_text = QLabel(self)
        n2_text.setStyleSheet("QLabel { background-color : transparent; color : black; font-size : 20px;}")
        ...
        n2_line.setStyleSheet("background-color: #f7bb6e;")

        ts_text = QLabel(self)
        ts_text.setStyleSheet("QLabel { background-color : transparent; color : black; font-size : 20px;}")
        ...
        ts_line.setStyleSheet("background-color: #f7bb6e;")
        ...
        ults_text.setStyleSheet("QLabel { background-color : transparent; color : black; font-size : 18px;}")
        ults_text.resize(750,25)
        ults_text.setText("Último Número da Sequencia: X")
        ults_text.move(50,310)

        ulto_text = QLabel(self)
        ulto_text.setStyleSheet("QLabel { background-color : transparent; color : black; font-size : 18px;}")
        ulto_text.resize(750,25)
        ulto_text.setText("Último Número de Ouro: X")
        ulto_text.move(50,340)

        tls_text = QLabel(self)
        tls_text.setStyleSheet("QLabel { background-color : transparent; color : black; font-size : 20px;}")
        ...
        tlo_text.setStyleSheet("QLabel { background-color : transparent; color : black; font-size : 20px;}")
        ...
        creator_button = QToolButton(self)
        creator_button.setGeometry(710, 810, 40, 40)
